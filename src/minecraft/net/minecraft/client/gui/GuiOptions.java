...
import net.minecraft.afyaan.override.GuiInGameHook;
import net.minecraft.afyaan.override.GuiSettingsCheat;
import net.minecraft.afyaan.override.TestGui;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        if(GuiInGameHook.gui){
            this.buttonList.add(new GuiButton(201, this.width / 2 - 77, this.height / 6 + 21 - 6, 150, 20, I18n.format("§2§lClient Settings", new Object[0])));
            this.buttonList.add(new GuiButton(202, this.width / 2 - 155, this.height / 6 + 48 - 6, 150, 20, I18n.format("§2§lSet UserName", new Object[0])));
        }
    }
    ...
    protected void actionPerformed(GuiButton p_146284_1_)
    {
        if (p_146284_1_.enabled)
        {
            ...
            {
                this.mc.gameSettings.saveOptions();
                this.mc.displayGuiScreen(new GuiSettingsCheat(this, this.field_146443_h));
            }
            
            if (p_146284_1_.id == 202)
            {
                this.mc.gameSettings.saveOptions();
                this.mc.displayGuiScreen(new TestGui(this, Session.getUsername()));
            }
        }
    }
