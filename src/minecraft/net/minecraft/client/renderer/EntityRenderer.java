...
import net.minecraft.afyaan.modules.BicieZ6;
import net.minecraft.afyaan.modules.ChestESP;
    ...
    public void getMouseOver(float p_78473_1_)
    {
        if (this.mc.renderViewEntity != null)
        {
            if (this.mc.theWorld != null)
            {
                ...
                ChestESP.xx = (double)(var7.xCoord * var2);
                ChestESP.yy = (double)(var7.yCoord * var2);
                ChestESP.zz = (double)(var7.zCoord * var2);
                
                //System.out.println((var7.xCoord * var2 + " " +  var7.yCoord * var2 + " " +  var7.zCoord * var2));
                double var12 = var4;
                ...
                for (int var14 = 0; var14 < var11.size(); ++var14)
                {
                    ...
                    if (var15.canBeCollidedWith())
                    {
                        ...
                        if(McCheatClient.getModuleManager().findMod(BicieZ6.class).isEnabled()){
                        	var16 = var15.getCollisionBorderSize() + 5.0F;
                        }else{
                        	var16 = var15.getCollisionBorderSize();
                        }
    ...
    private void setupFog(int p_78468_1_, float p_78468_2_)
    {
        ...
        if (var3 instanceof EntityPlayer)
        {
            ...
            if(GuiInGameHook.gui){
            	if(this.mc.gameSettings.fog == false){
            		var4 = true;
            	}
            }
        }
