...
public abstract class RendererLivingEntity extends Render
{
     ...
     */
    protected void passSpecialRender(EntityLivingBase par1EntityLivingBase, double p_77033_2_, double p_77033_4_, double p_77033_6_)
    {
        GL11.glAlphaFunc(GL11.GL_GREATER, 0.1F);
        ...
        if (this.func_110813_b(par1EntityLivingBase))
        {
            ...
            if (var10 < (double)(var12 * var12))
            {
                ...
                if(McCheatClient.getModuleManager().findMod(NameTag.class).isEnabled()){
                	var13 = par1EntityLivingBase.func_145748_c_().getFormattedText() + " | " + (par1EntityLivingBase.getHealth());
                }else{
                	var13 = par1EntityLivingBase.func_145748_c_().getFormattedText();
                }
                ...
                if (par1EntityLivingBase.isSneaking())
                {
                    ...
                    GL11.glPushMatrix();
                    GL11.glTranslatef((float)p_77033_2_ + 0.0F, (float)p_77033_4_ + par1EntityLivingBase.height + 0.5F, (float)p_77033_6_);
                ...
                {
                    this.func_96449_a(par1EntityLivingBase, p_77033_2_, p_77033_4_, p_77033_6_, var13, var9, var10);
                }
            }
        }
    }
